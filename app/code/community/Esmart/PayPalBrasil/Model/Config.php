...
class Esmart_PayPalBrasil_Model_Config extends Mage_Paypal_Model_Config
{
    ...
    {
		$_horizontal 	= $this->_helper()->__('Horizontal');
		$_vertical 		= $this->_helper()->__('Vertical');
		$_colored 		= $this->_helper()->__('Colored');
		$_blackAndWhite = $this->_helper()->__('Black and White');

		return array(
            'selo_aceitacao_horizontal'             => $this->_helper()->__('Now Accepting PayPal Logo (%s, %s)', $_horizontal, $_colored),
            'selo_aceitacao_vertical'               => $this->_helper()->__('Now Accepting PayPal Logo (%s, %s)', $_vertical, $_colored),

            'selo_aceitacao_horizontal_pb'          => $this->_helper()->__('Now Accepting PayPal Logo (%s, %s)', $_horizontal, $_blackAndWhite),
            'selo_aceitacao_vertical_pb'            => $this->_helper()->__('Now Accepting PayPal Logo (%s, %s)', $_vertical, $_blackAndWhite),

            'selo-preferencia_loja_horizontal'      => $this->_helper()->__('This Store Prefer PayPal Logo (%s, %s)', $_horizontal, $_colored),
            'selo-preferencia_loja_vertical'        => $this->_helper()->__('This Store Prefer PayPal Logo (%s, %s)', $_vertical, $_colored),

            'selo-preferencia_sbandeira_horizontal' => $this->_helper()->__('We Prefer PayPal Logo (%s, %s)', $_horizontal, $_colored),
            'selo-preferencia_sbandeira_vertical'   => $this->_helper()->__('We Prefer PayPal Logo (%s, %s)', $_vertical, $_colored),

            'selo-preferencia_site_horizontal'      => $this->_helper()->__('This Website Prefer PayPal Logo (%s, %s)', $_horizontal, $_colored),
            'selo-preferencia_site_vertical'        => $this->_helper()->__('This Website Prefer PayPal Logo (%s, %s)', $_vertical, $_colored),

            'compra_segura_horizontal'              => $this->_helper()->__('Secure Purchase PayPal Logo (%s, %s)', $_horizontal, $_colored),
            'compra_segura_vertical'                => $this->_helper()->__('Secure Purchase PayPal Logo (%s, %s)', $_vertical, $_colored),

            'compra_segura_horizontal_pb'           => $this->_helper()->__('Secure Purchase PayPal Logo (%s, %s)', $_horizontal, $_blackAndWhite),
            'compra_segura_vertical_pb'             => $this->_helper()->__('Secure Purchase PayPal Logo (%s, %s)', $_vertical, $_blackAndWhite),
        );
    }
